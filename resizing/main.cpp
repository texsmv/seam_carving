...
int main( int argc, char** argv )
{
    ...
    int opcion_imagen = 0;
    cout<<"Ingresar nombre de la imagen"<<endl;
    cout<<"1.- playa"<<endl;
    cout<<"2.- lanchas"<<endl;
    cout<<"3.- torre de hercules"<<endl;
    cout<<"4.- paisaje"<<endl;
    cout<<"5.- ciudad"<<endl;
    cout<<"6.- turistas"<<endl;
    ...
    switch (opcion_imagen) {
      ...
      break;
      case 6: nombre_imagen = path + "turistas.jpg";
      break;
    ...
    int x;
    int y;
    cout<<"Ingrese ingrese nueva dimension en x"<<endl;
    cin>>x;
    cout<<"Ingrese ingrese nueva dimension en y"<<endl;
    cin>>y;
